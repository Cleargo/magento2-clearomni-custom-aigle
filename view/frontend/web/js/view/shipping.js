...
define([
    ...
    return Component.extend({
        ...
        currentRetailerId:ko.observable(window.checkoutConfig.currentStore),
        ...
        initialize: function () {
            ...
            this.currentRetailerId.subscribe(function(){
                self.updateStore();
            })
        ...
        /**
         * Change store when select is changed
         */
        updateStore:function(){
            var address=quote.shippingAddress();
            var self=this;
            // quote.shippingAddress(selectedAddress);
            $('body').trigger('processStart');
            return $.ajax({
                'url':'/cnr/store/set',
                'data':{
                    'store':self.currentRetailerId
                }
